...
with open('src/initialState.js', 'r') as f:
    content = f.read()

replacement = """export const initialFormState = {
  personalDetails: {
    customerId: '',
    ckycNumber: '',
    abhaNumber: '',
...
new_content = re.sub(r'export const initialFormState = \{.*?\n\};\n', replacement, content, flags=re.DOTALL)

if 'export const initialFormState = {' not in new_content:
    # If regex failed, just overwrite
    new_content = replacement

with open('src/initialState.js', 'w') as f:
    f.write(new_content)
